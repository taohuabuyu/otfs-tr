...
acceptance.referenceAlignmentPass = ~isfield(result, ...
    "referenceAlignmentPass") || result.referenceAlignmentPass;
...
acceptance.pass = acceptance.berPass && acceptance.testBitsPass && ...
    ...
    acceptance.referenceAlignmentPass && acceptance.radioPass;
end
